...
export default function Flower() {
    ...
    if (JSON.parse(localStorage.getItem('user_json')) !== null) {
        store_id = JSON.parse(localStorage.getItem('user_json')).user.id
    }
        ...
        <div>
            ...
            <Row className="ml-5 ml-lg-5">
                <Col className="ml-5 ml-lg-5 mt-5">
                    ...
                    <h4>{flower.price}</h4>
                <Button className="ml-2 ml-lg-0 mt-1" variant="success" onClick={store_id? addToCart: redirectTo}>Add to cart
                </Button>
